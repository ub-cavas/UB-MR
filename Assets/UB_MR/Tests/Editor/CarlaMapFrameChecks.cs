    ...
    public static class CarlaMapFrameChecks
    {
        ...
        static void RuntimeConsumers()
        {
            ...
            try
            {
                ...
                var vehicles = Get<Dictionary<string, GameObject>>(renderer, "spawnedVehicles");
                GameObject vehicle = vehicles["traffic-check"];
            ...
            {
                foreach (var vehicle in Get<Dictionary<string, GameObject>>(renderer, "spawnedVehicles").Values)
                    Object.DestroyImmediate(vehicle);
                Get<Dictionary<string, GameObject>>(renderer, "spawnedVehicles").Clear();
